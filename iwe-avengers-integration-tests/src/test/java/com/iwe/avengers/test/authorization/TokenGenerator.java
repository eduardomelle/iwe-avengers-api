...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "37k9jb9frdggunubgb1tk7dn6m";
		final String userPoolId = "us-east-2_AauueXRFh";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "eduardomelle");
